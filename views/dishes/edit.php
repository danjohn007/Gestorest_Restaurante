                ...
                <form method="POST" class="needs-validation" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" id="has_validity" name="has_validity" 
                                           <?= ($old['has_validity'] ?? $dish['has_validity'] ?? '0') == '1' ? 'checked' : '' ?>>
                            ...
                            <div id="validity-settings" style="display: <?= ($old['has_validity'] ?? $dish['has_validity'] ?? '0') == '1' ? 'block' : 'none' ?>;">
                                <!-- Date Range -->
                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input 
                                            ...
                                            id="validity_start" 
                                            name="validity_start" 
                                            value="<?= htmlspecialchars($old['validity_start'] ?? $dish['validity_start'] ?? '') ?>"
                                        >
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input 
                                            ...
                                            id="validity_end" 
                                            name="validity_end" 
                                            value="<?= htmlspecialchars($old['validity_end'] ?? $dish['validity_end'] ?? '') ?>"
                                        >
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        $selectedDays = $old['availability_days'] ?? $dish['availability_days'] ?? '';
                                        ?>
