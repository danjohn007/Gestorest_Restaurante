...
<div class="d-flex justify-content-between align-items-center mb-4">
    ...
    <div>
        ...
        <a href="<?= BASE_URL ?>/tables/liberateAllTables" class="btn btn-outline-warning me-2">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($user['role'] === ROLE_WAITER): ?>
                                    <!-- Enhanced view for waiters showing assignment details -->
                                    <?php if (isset($table['assignment_status'])): ?>
                                        <div class="d-flex align-items-center">
                                            <?php if ($table['assignment_type'] === 'available'): ?>
                                                <span class="badge bg-success me-2">
                                                    <i class="bi bi-unlock"></i> <?= htmlspecialchars($table['assignment_status']) ?>
                                                </span>
                                            <?php elseif ($table['assignment_type'] === 'mine'): ?>
                                                <span class="badge bg-primary me-2">
                                                    <i class="bi bi-person-check"></i> <?= htmlspecialchars($table['assignment_status']) ?>
                                                </span>
                                            <?php else: ?>
                                                <span class="badge bg-warning text-dark me-2">
                                                    <i class="bi bi-person-lock"></i> <?= htmlspecialchars($table['assignment_status']) ?>
                                                </span>
                                            <?php endif; ?>
                                        </div>
                                        <?php if ($table['waiter_name'] && $table['assignment_type'] !== 'mine'): ?>
                                            <small class="text-muted">
                                                Código: <?= htmlspecialchars($table['employee_code']) ?>
                                            </small>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php else: ?>
