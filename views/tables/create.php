                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label for="number" class="form-label">
                                    <i class="bi bi-hash"></i> Identificador de Mesa *
                                </label>
                                <input 
                                    type="text" 
                                    ...
                                    placeholder="Ej: A1, B2, C3, 1, 2..."
                                    required
                                    maxlength="10"
                                    pattern="^[A-Za-z]?[0-9]+$"
                                    title="Ingrese un identificador válido: letra opcional seguida de números (Ej: A1, B2, 1, 2)"
                                >
                                ...
                                <?php endif; ?>
                                <div class="form-text">
                                    Identificador único: letra opcional seguida de números (Ej: A1, B2, C3, o simplemente 1, 2, 3)
                                </div>
                            </div>
                        </div>
